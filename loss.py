...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        min_length = min(len(src_boxes), len(image_size))
        src_boxes_ = src_boxes[:min_length] / image_size[:min_length]
        target_boxes_ = target_boxes[:min_length] / image_size[:min_length]
